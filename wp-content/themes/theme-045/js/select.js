(function($) {
  $(function() {
    ...
    // Get initial value
    $selectValue.text($('#esp_value').val());
	$selectValue.text($('#area').val());
	$selectValue.text($('#type').val());
	$selectValue.text($('#minprice').val());
	$selectValue.text($('#maxprice').val());
	$selectValue.text($('#rooms').val());
	$selectValue.text($('#gridviewlist').val());
	

    // Initialize Selectric and bind to 'change' event
  /*    
    $('#esp_value').selectric().on('change', function() {
      $selectValue.text($(this).val());
    });
*/

	$('#area').selectric().on('change', function() {
      $selectValue.text($(this).val());
    });
	$('#type').selectric().on('change', function() {
      $selectValue.text($(this).val());
    });
	$('#minprice').selectric().on('change', function() {
      $selectValue.text($(this).val());
    });
	$('#maxprice').selectric().on('change', function() {
      $selectValue.text($(this).val());
    });
	$('#rooms').selectric().on('change', function() {
      $selectValue.text($(this).val());
    });
	$('#gridviewlist').selectric().on('change', function() {
      $selectValue.text($(this).val());
    });
