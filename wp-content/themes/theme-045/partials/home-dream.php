...
$url_video = get_field( '_project045_home_video' );

while( have_rows( '_project045_home_dream' ) ) {
    the_row();
...
<section class="costa_del_sol">
    ...
    <div class="container">
        ...
        <a href="<?php echo pll_home_url(); ?><?php if( 'es' == pll_current_language() ) echo 'areas-es'; else echo 'areas'; ?>"><?php _e( 'VER AREAS', 'project045' ); ?></a>
        </div>
    </div>
</section>
